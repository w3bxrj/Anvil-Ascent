"""
PR GENERATOR: Creates actual code patch — not just comment
...
class PRGenerator:
    ...
    def generate_patch(self, file_path: str, original_content: str,
        ...
        """
        # Simple: Find the problematic line and suggest replacement
        lines = original_content.split('\n')
        
        # Naive approach: find function mentioned in solution
        patch_lines = []
        in_function = False
        ...
        for i, line in enumerate(lines):
            ...
            if in_function and ('return' in line or 'pass' in line):
                # Suggest adding null check before return
...
```"""
    ...
    def _extract_function_name(self, solution_text: str) -> str:
        ...
        import re
        # Look for patterns like "function X" or "def X"
...
### ✅ Validation
- Critic Score: {critic_result['scores']['overall']:.0f}/100
