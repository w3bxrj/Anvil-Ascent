"""
Repo Indexer: Clone repo OR use local path, parse files, create embeddings in ChromaDB
"""
...
class RepoIndexer:
    ...
    def __init__(self, persist_dir: str = "./data/chroma_db"):
        ...
        # Initialize ChromaDB (new API for v0.4+)
        os.makedirs(persist_dir, exist_ok=True)
        self.client = chromadb.PersistentClient(path=persist_dir)
        
        # Collection per repo (created on demand)
        self.collections = {}
    ...
    def _index_batch(self, collection, files: List[Dict], repo_name: str):
        ...
        for i, file in enumerate(files):
            ...
            # Create chunks for large files (simple: first 3000 chars)
